...
function previewImage(event) {
  ...
  const preview = document.getElementById('previewImage'); // Lấy phần tử hiển thị ảnh preview

  if (file) {
    const reader = new FileReader(); // Tạo instance của FileReader
    reader.onload = function(e) {
      preview.src = e.target.result; // Đặt src cho ảnh preview
