// lib/screens/reading_level_selection_screen.dart
import 'package:flutter/material.dart';

class ReadingLevelSelectionScreen extends StatefulWidget {
  final Function(int level, String topic) onSettingsSelected;

  const ReadingLevelSelectionScreen({Key? key, required this.onSettingsSelected})
      : super(key: key);

  @override
  _ReadingLevelSelectionScreenState createState() =>
      _ReadingLevelSelectionScreenState();
}

class _ReadingLevelSelectionScreenState
    extends State<ReadingLevelSelectionScreen> {
  int? _selectedLevel;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tùy Chỉnh Bài Đọc', style: TextStyle(fontWeight: FontWeight.bold)),
        foregroundColor: Colors.white,
        backgroundColor: primaryPink,
        elevation: 1,
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _buildSectionTitle('1. Chọn độ khó (IELTS Band)', Icons.leaderboard_outlined),
              Card(
                elevation: 2,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                child: Padding(
