// lib/widgets/draggable_image_editor.dart
...
class _DraggableImageEditorState extends State<DraggableImageEditor> {
  ...
  final ValueNotifier<Alignment> _alignmentNotifier = ValueNotifier(Alignment.center);
  ...
  void didUpdateWidget(covariant DraggableImageEditor oldWidget) {
    ...
    if (widget.imageBase64 != null && oldWidget.imageBase64 != widget.imageBase64) {
